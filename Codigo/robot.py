...
class Robot:
    ...
    def iniciar_robot(self):
        self.connect(19999)
        #SetJoints
        ret,Joint_Base=self.getObjectHandler('Joint_Base')
        ret,Joint_Hombro=self.getObjectHandler('Joint_Hombro')
        ret,Joint_Codo=self.getObjectHandler('Joint_Codo')
        ret,Joint_Muneca=self.getObjectHandler('Joint_Muneca')
        ret,Joint_Pinza=self.getObjectHandler('Joint_Pinza')
        ret,Joint_Cam=self.getObjectHandler('Joint_Cam')
        ...
        ret,sensorHandle = self.getObjectHandler('Vision_sensor')
